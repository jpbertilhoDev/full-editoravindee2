        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <h2 className="text-2xl font-bold tracking-tight">{t('home.bestsellers.title', 'Mais Vendidos')}</h2>
            </div>
            <p className="text-muted-foreground text-sm max-w-md">
              {t('home.bestsellers.subtitle', 'Descubra os livros que estão fazendo sucesso entre os nossos leitores')}
            </p>
          </div>
          ...
          >
            {t('home.bestsellers.viewAll', 'Ver Todos')}
