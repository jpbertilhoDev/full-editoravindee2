...
import { ShoppingBag, Star, Shield, TrendingUp, Fire } from 'lucide-react';
...
const Testimonials = ({ testimonials }: TestimonialsProps) => {
  // Selecionar apenas 3 produtos mais vendidos para exibição estática
  ...
  return (
    <section className="py-16 bg-gradient-to-b from-white to-gray-50">
      <div className="container mx-auto px-4">
        ...
        {/* Produtos Mais Vendidos - Versão Simplificada */}
        <div className="mb-16">
            ...
            {bestSellers.map((product) => (
              ...
              >
                <Link href={`/products/${product.slug}`} className="block">
                  ...
                  <div className="p-4">
                    <h4 className="font-medium text-gray-800 text-lg mb-1 truncate">{product.title}</h4>
                    <p className="text-sm text-gray-500 mb-2 truncate">{product.author}</p>
                      ...
                      <div className="flex items-center mr-2">
                        {[...Array(5)].map((_, i) => (
                          <Star
                            key={i}
                            className={`h-3 w-3 ${
                              i < Math.round(product.rating) ? 'text-yellow-400 fill-yellow-400' : 'text-gray-200'
                            }`}
                          />
                        ))}
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <span className="font-bold text-gray-800">R$ {product.price}</span>
