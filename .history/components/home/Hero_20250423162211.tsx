      ...
      <div className="container mx-auto px-4 py-16 md:py-24 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            className="space-y-6"
          >
            <div className="inline-flex items-center px-4 py-2 rounded-md bg-[#e9ffff] border border-[#08a4a7]/10 text-[#08a4a7] text-sm font-medium">
              <BookOpen className="h-4 w-4 mr-2 text-[#08a4a7]" />
            ...
            <div className="pt-4 flex items-center text-sm text-gray-600 bg-[#e9ffff] p-3 rounded-md border border-[#08a4a7]/10 max-w-max">
          ...
          >
            ...
            >
              ...
              <p className="text-sm text-gray-500">Save up to 30% on selected titles</p>
            </motion.div>
