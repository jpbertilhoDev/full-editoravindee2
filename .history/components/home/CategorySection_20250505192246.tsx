...
const CategorySection = ({ categories, title = "Browse Categories" }: CategorySectionProps) => {
    ...
    <section className="py-20 bg-gradient-to-b from-white to-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          >
            {t('home.categories.description', 'Explore our curated collection of books organized by category, designed to inspire and strengthen your faith journey.')}
          </motion.p>
        </div>
