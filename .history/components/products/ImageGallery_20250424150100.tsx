...
export default function ImageGallery({ images: propImages, title }: ImageGalleryProps) {
  ...
  const demoImages = [
    // Imagens do livro "Mere Christianity" de C.S. Lewis
    ...
    "https://images-na.ssl-images-amazon.com/images/I/71yTX7oQKWL.jpg", // Lombada
    "https://images-na.ssl-images-amazon.com/images/I/71wA2AnaWgL.jpg", // Detalhe interno
  ];
  ...
  return (
    <div className="relative flex flex-col md:flex-row gap-2">
      ...
      <div className="order-2 md:order-1 md:w-12 flex md:flex-col gap-1.5 overflow-x-auto md:overflow-y-auto pb-1 md:pb-0 md:pr-0 pr-1 md:max-h-[360px] scrollbar-thin scrollbar-thumb-gray-300">
