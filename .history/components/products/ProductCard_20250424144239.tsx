...
import { ShoppingCart, Heart, Bookmark, Star, StarHalf } from 'lucide-react';
      ...
      <div className="relative">
        ...
        <div className={cn(
          ...
          <Button 
            ...
            size="icon" 
            className={cn(
              "rounded-full shadow-md h-8 w-8",
              productInWishlist 
          ...
          >
            <Heart className={cn("h-4 w-4", productInWishlist && "fill-white")} />
