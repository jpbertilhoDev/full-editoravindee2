          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-0">
            ...
            <div className="lg:col-span-7 p-4 md:p-6 flex flex-col lg:border-l border-gray-100">
              ...
              <div className="flex items-baseline gap-2 mb-4">
                <span className="text-2xl font-bold text-gray-900">{formatPriceEUR(product.price)}</span>
                {hasDiscount && (
                  <span className="text-gray-500 line-through text-sm">{formatPriceEUR(product.originalPrice || 0)}</span>
                )}
              </div>
        ...
        {relatedProducts.length > 0 && (
          <div className="mb-8">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link
                href="/products"
                className="text-[#26a69a] hover:text-[#2bbbad] font-medium text-xs flex items-center"
              >
                View all
                ...
                >
                  <div className="aspect-[3/4] relative overflow-hidden">
                    ...
                    {relatedProduct.bestSeller && (
                      <span className="absolute top-2 left-2 bg-amber-500 text-white text-[10px] font-medium px-1.5 py-0.5 rounded">
                        Bestseller
                      </span>
                    )}
                    {relatedProduct.newRelease && (
                      <span className="absolute top-2 left-2 bg-blue-500 text-white text-[10px] font-medium px-1.5 py-0.5 rounded">
                        New
                      </span>
                    )}
                  </div>
                  <div className="p-2.5">
                    ...
                    <p className="text-xs text-gray-500 my-0.5 line-clamp-1">{relatedProduct.author}</p>
                    <div className="flex items-center justify-between">
                      <span className="font-semibold text-xs">{formatPriceEUR(relatedProduct.price)}</span>
