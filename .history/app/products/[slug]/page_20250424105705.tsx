...
import { Heart, ShoppingCart, Star, ChevronRight, Truck } from 'lucide-react';
      ...
      <div className="container max-w-5xl px-4">
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-8 transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-0">
            {/* Left Column - Image */}
            <div className="lg:col-span-4 relative bg-gray-50">
              <div className="aspect-[3/4] relative">
                ...
                {/* Discount Badge */}
                {hasDiscount && (
                  <div className="absolute top-4 right-4 bg-red-500 text-white text-xs font-bold px-2 py-1 rounded-sm">
            ...
            <div className="lg:col-span-8 p-6 flex flex-col">
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                ...
                <div className="flex items-center border border-gray-100 rounded-md p-2">
                  <span className="text-xs text-gray-700">HarperOne</span>
                </div>
              </div>
