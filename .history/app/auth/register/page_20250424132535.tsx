      ...
      <div className="w-full max-w-4xl grid md:grid-cols-2 overflow-hidden rounded-2xl shadow-xl">
        ...
        <div className="hidden md:block relative bg-gradient-to-br from-[#08a4a7] to-[#0bdbb6] p-8 text-white">
          ...
          <div className="relative z-10 h-full flex flex-col justify-between">
            <div>
              <h1 className="text-3xl font-bold mb-2">Junte-se à Grace Bookstore</h1>
              <p className="text-white/80">
                Crie sua conta e descubra um mundo de conhecimento e inspiração
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg">
                <p className="italic text-sm text-white/90 mb-2">
                  "Os livros nos permitem viajar sem mover os pés."
                </p>
                <p className="text-xs text-white/70 text-right">— Jhumpa Lahiri</p>
              </div>
        ...
        <div className="bg-white p-8 md:p-10">
          <div className="text-center mb-6 md:text-left">
            ...
            <p className="text-sm text-gray-500 mt-1">
              Já tem uma conta? <Link href="/auth/login" className="text-[#08a4a7] font-medium hover:underline">Faça login</Link>
            </p>
          </div>
                  ...
                  <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md p-4 border">
                    ...
                    <div className="space-y-1 leading-none">
                      <FormLabel className="text-sm font-normal cursor-pointer">
                        Eu concordo com os <Link href="/terms" className="text-[#08a4a7] hover:underline">Termos de Uso</Link> e <Link href="/privacy" className="text-[#08a4a7] hover:underline">Política de Privacidade</Link>
                      </FormLabel>
                      <FormMessage />
                    </div>
                  </FormItem>
