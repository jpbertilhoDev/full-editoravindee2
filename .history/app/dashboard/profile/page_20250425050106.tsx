...
export const metadata = {
  title: 'Meu Perfil | Grace Bookstore',
  description: 'Gerencie suas informações pessoais, endereço e configurações de segurança na sua conta.',
  keywords: 'perfil de usuário, configurações de conta, gestão de perfil, dados pessoais',
  openGraph: {
    title: 'Meu Perfil | Grace Bookstore',
    description: 'Gerencie suas informações pessoais, endereço e configurações de segurança',
    type: 'website',
  }
};
