...
export default function ProfilePage() {
  ...
  const handleRemoveAvatar = async () => {
    ...
    try {
      ...
      // Remover foto do Firebase Auth
      await updateProfile(auth.currentUser!, {
        photoURL: null
      });
      
      console.log("Foto removida do Auth"); // Log para debug
      ...
      console.log("Foto removida do Firestore"); // Log para debug
      
      // Limpar o avatar local
      setAvatarFile(null);
      
      // Atualizar os dados do usuário no contexto
      if (refreshUserData) {
        await refreshUserData();
        console.log("Dados do usuário atualizados"); // Log para debug
      }
  ...
  const handleAvatarChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // Converter a URL de dados para blob para upload
      ...
      console.log("Foto URL:", downloadURL);
              ...
              <Avatar className="h-28 w-28">
                {avatarFile ? (
                  <AvatarImage 
                    ...
                    onError={() => console.error("Erro ao carregar imagem local")}
                  />
                ) : user?.photoURL ? (
                  <AvatarImage 
                    src={user.photoURL} 
