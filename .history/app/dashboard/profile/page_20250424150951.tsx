...
export default function ProfilePage() {
  ...
  const profileForm = useForm<ProfileFormValues>({
    ...
    defaultValues: {
      ...
      phone: "(11) 98765-4321",
      bio: "Leitor ávido de obras clássicas e ficção científica. Apaixonado por literatura brasileira.",
    },
  });
          ...
          <CardContent className="pt-6 pb-4 flex flex-col items-center">
            <div className="relative">
              <Avatar className="h-28 w-28">
                ...
                <AvatarFallback className="bg-[#08a4a7]">JS</AvatarFallback>
              </Avatar>
              <Button 
                variant="outline" 
                size="icon" 
            ...
            <h3 className="text-lg font-medium mt-4">João Silva</h3>
            <p className="text-muted-foreground text-sm">Cliente desde Abril 2022</p>
                ...
                <Form {...profileForm}>
                  <form onSubmit={profileForm.handleSubmit(onProfileSubmit)} className="space-y-4">
                    ...
                    <div className="flex justify-end">
                      <Button type="submit" className="bg-[#08a4a7] hover:bg-[#08a4a7]/90">
