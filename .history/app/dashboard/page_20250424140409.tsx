              ...
              <CardContent className="pt-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                  {userData.recommendations.map((book) => (
                    <div key={book.id} className="rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden flex flex-col transition-all duration-300 hover:shadow-lg hover:border-[#08a4a7]/30 bg-white">
                      <div className="h-52 w-full bg-gradient-to-br from-gray-200 to-gray-100 dark:from-gray-800 dark:to-gray-700 relative">
                        <div className="absolute inset-0 flex items-center justify-center text-gray-400">
                        ...
                        <div className="absolute top-3 right-3">
                          <Button variant="ghost" size="icon" className="h-8 w-8 rounded-full bg-white/80 backdrop-blur-sm border border-white hover:bg-white">
                            <Heart className="h-4 w-4 text-rose-500" />
                          </Button>
                        </div>
                      </div>
                      <div className="p-4 flex-1 flex flex-col">
                        ...
                        <div className="mt-auto flex items-center justify-between">
                          <span className="font-bold text-lg text-[#08a4a7]">R$ {book.price.toFixed(2)}</span>
                          <Button variant="default" size="sm" className="bg-[#08a4a7] hover:bg-[#0bdbb6]">
                            <ShoppingCart className="h-4 w-4 mr-2" />
                            Comprar
                          </Button>
