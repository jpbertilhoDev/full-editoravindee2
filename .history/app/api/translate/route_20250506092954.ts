...
const fallbackTranslations = {
  ...
  es: {
    common: {
      ...
      "hero.description": "Explore nuestra cuidadosamente seleccionada colección de Biblias, devocionales y literatura cristiana para fortalecer su camino espiritual.",
      "hero.shop_now": "Comprar Ahora",
      "hero.bestsellers": "Más Vendidos",
      "hero.trusted_by": "Confiado por más de 10.000 clientes satisfechos en todo el mundo"
    }
  },
  ...
  fr: {
    common: {
      ...
      "hero.description": "Explorez notre collection soigneusement organisée de Bibles, livres de dévotion et littérature chrétienne pour renforcer votre cheminement spirituel.",
      "hero.shop_now": "Acheter Maintenant",
      "hero.bestsellers": "Meilleures Ventes",
      "hero.trusted_by": "Faire confiance par plus de 10 000 clients satisfaits dans le monde entier"
    }
  },
  ...
  de: {
    common: {
      ...
      "hero.description": "Entdecken Sie unsere sorgfältig zusammengestellte Sammlung von Bibeln, Andachtsbüchern und christlicher Literatur, um Ihren spirituellen Weg zu stärken.",
