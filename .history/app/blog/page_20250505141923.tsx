  ...
  if (error) {
    return (
      <div className="container mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold text-center mb-6">Nosso Blog</h1>
        <div className="bg-gray-50 border border-gray-200 p-6 rounded-lg max-w-2xl mx-auto text-center">
          <h2 className="text-xl font-medium mb-2">Nosso blog está temporariamente indisponível</h2>
          <p className="text-gray-600 mb-4">Estamos enfrentando dificuldades técnicas. Por favor, tente novamente em alguns instantes.</p>
          <Button className="mt-4 bg-brand-petrol hover:bg-brand-petrol/90 text-white" onClick={() => fetchBlogPosts(1, selectedCategory)}>
            Tentar novamente
          </Button>
        </div>
      </div>
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      {memoizedFilteredPosts.length === 0 && !isLoading && !error && (
        <div className="bg-gray-50 border border-gray-200 p-6 rounded-lg max-w-2xl mx-auto text-center mb-10">
          <p className="text-gray-700 mb-4">Não encontramos nenhum conteúdo disponível no momento. Nossos editores estão trabalhando para trazer novos artigos em breve.</p>
          <Button 
