...
// Componente de skeleton loader para posts memoizado
...
export default function BlogPage() {
  ...
  // Função para alterar categoria com transition
  ...
  // Posts filtrados memorizados para evitar re-renders desnecessários
  ...
  useEffect(() => {
    ...
    // Prefetch post cards (importante para otimização)
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      {/* Estado de carregamento durante transições */}
      {isPending && (
