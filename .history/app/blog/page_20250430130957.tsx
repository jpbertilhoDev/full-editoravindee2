...
import { Search, Calendar, User, Tag, ChevronRight, FileText } from 'lucide-react';
...
// Função para carregar os dados do blog durante o build
async function getBlogPosts() {
  try {
    ...
    console.log('Posts do blog encontrados:', fetchedPosts.length);
    
    return {
      posts: fetchedPosts,
      featuredPosts: featured.slice(0, 2), // Limitar a 2 posts em destaque
...
export default async function BlogPage() {
  const { posts, featuredPosts, categories } = await getBlogPosts();
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      {/* Filtros - versão não interativa para SSG */}
      <div className="mb-10">
