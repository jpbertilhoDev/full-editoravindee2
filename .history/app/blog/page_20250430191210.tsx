...
import { Search, FileText, Loader2, Calendar, User, Tag } from 'lucide-react';
      ...
      <div className="container py-8">
        ...
        <Link href={`/blog/${post.slug}`} prefetch={false} className="block">
          <div className="group grid md:grid-cols-2 gap-8 items-center">
            <div className="relative aspect-[16/9] w-full overflow-hidden rounded-xl bg-gray-100 shadow-lg transform transition-transform duration-300 group-hover:scale-[1.02]">
              {post.imageUrl ? (
                <img 
                  src={post.imageUrl} 
                  alt={post.title}
