...
const categories = Array.from(
  new Set([...featuredPosts, ...posts].map(post => post.category))
).sort();
            ...
            <Card key={post.id} className="flex flex-col h-full overflow-hidden transition-shadow hover:shadow-lg">
              <div className="relative aspect-[16/9] w-full">
                ...
                <Link 
                  ...
                  className="absolute top-4 left-4 bg-white px-3 py-1 rounded-full text-sm font-medium text-gray-800 hover:bg-gray-100 transition-colors"
                >
                  {post.category}
                </Link>
              </div>
