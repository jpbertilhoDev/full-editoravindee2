        ...
        {comments.length > 0 ? (
          <div className="space-y-6">
            {comments.map((comment) => (
              <div key={comment.id} className="border border-gray-200 p-4 rounded-md bg-gray-50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {relatedPosts.map((relatedPost) => (
              <Link key={relatedPost.id} href={`/blog/${relatedPost.slug}`} prefetch={false}>
                <div className="group h-full border border-gray-200 rounded-lg overflow-hidden transition-colors hover:border-primary hover:shadow-sm">
                  ...
                  <div className="p-4">
                    <h3 className="font-semibold truncate group-hover:text-primary text-gray-800">
                      {relatedPost.title}
                    </h3>
