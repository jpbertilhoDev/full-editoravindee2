...
import { ArrowLeft, Calendar, User, Tag, MessageSquare, Share2, Loader2 } from 'lucide-react'
    ...
    async function fetchPostData() {
      try {
        ...
        if (postDocSnapshot.exists()) {
          ...
          currentPost = { id: postDocSnapshot.id, ...postDocSnapshot.data() } as BlogPost;
          console.log('Post encontrado pelo ID:', currentPost);
        } else {
          // Tenta buscar por consulta where
          console.log('Post não encontrado pelo ID, buscando por slug...');
          const postsQuery = query(
            collection(db, 'blogPosts'),
          ...
          if (!querySnapshot.empty) {
            ...
            currentPost = { id: postDoc.id, ...postDoc.data() } as BlogPost;
            console.log('Post encontrado pela consulta:', currentPost);
          }
        }
        
        if (!currentPost) {
          console.log('Post não encontrado:', params.slug);
          setPost(null);
          setComments([]);
          setRelatedPosts([]);
        ...
        if (currentPost.category) {
          ...
          relatedSnapshot.forEach((doc) => {
            ...
            if (relatedPost.id !== currentPost.id) {
