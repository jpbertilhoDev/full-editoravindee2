...
// Cache timeout (10 minutes in ms)
...
export default function BlogPage() {
  ...
  const fetchPosts = useCallback(async () => {
    ...
    try {
      ...
      apiUrl.searchParams.append('limit', '6');
  ...
  const fetchCategories = useCallback(async () => {
    try {
      ...
      // In a production app, you might want a separate collection for categories
  ...
  // Memoize the pagination component to prevent re-renders
  ...
  return (
    <Container maxWidth="lg" sx={{ my: 4 }}>
      ...
      {!error && featuredPost && !loading && !currentCategory && !currentSearchTerm && (
        <Box sx={{ mb: 6 }}>
