...
export const currencySettings: Record<string, { currency: string, locale: string }> = {
...
export function formatDateByLocale(date: Date | string, locale: string = 'pt-BR'): string {
