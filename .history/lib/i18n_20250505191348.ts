...
const resources = {
  en: {
    translation: {
      ...
      "footer.newsletter_description": "Get the latest news, releases and special offers.",
      "footer.description": "Publishing quality Christian literature to transform lives and strengthen faith.",
  ...
  pt: {
    translation: {
      ...
      "footer.newsletter": "Newsletter",
      "footer.newsletter_description": "Receba novidades, lançamentos e ofertas exclusivas.",
      "footer.description": "Publicando literatura cristã de qualidade para transformar vidas e fortalecer a fé.",
  ...
  de: {
    translation: {
      ...
      "footer.help": "Hilfe",
      "footer.description": "Wir veröffentlichen christliche Literatur von höchster Qualität.",
  ...
  fr: {
    translation: {
      ...
      "footer.help": "Aide",
      "footer.description": "Publication de littérature chrétienne de qualité pour transformer des vies.",
